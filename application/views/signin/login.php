...
<html lang="en">
<head>
	<title>Login :: Sistem Informasi Bimbingan Tugas Akhir</title>
	<meta charset="UTF-8">
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="<?php base_url()?>assets/login/fonts/Linearicons-Free-v1.0.0/icon-font.min.css">
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(<?php base_url()?>assets/login/images/bg-01.jpg);">
					<span class="login100-form-title-1">
						Sistem Informasi<br>Bimbingan Tugas Akhir
					</span>
				</div>

				<form action="<?php echo site_url('login/aksi_login')?>" method="POST" class="login100-form validate-form">
